...
int main(int argc, char ** argv) {
    ...
    llama_sampling_context sampling_context = llama_sampling_context_init(params, NULL);
    ...
    while (true) {
        ...
        for (int32_t i = 0; i < (int32_t) batch.n_tokens; i += n_batch) {
            ...
            for (auto & client : clients) {
                ...
                const llama_token id = llama_sampling_sample(ctx, NULL, sampling_context, client.tokens_prev, candidates, client.i_batch - i, client.seq_id);
                ...
                if (client.n_decoded > 2 &&
                    ...
                    llama_sampling_context_reset(sampling_context, client.seq_id);
                    client.seq_id = -1;
                }
