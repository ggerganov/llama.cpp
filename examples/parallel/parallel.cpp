...
int main(int argc, char ** argv) {
    ...
    llama_sampling_state sampling_state = llama_sampling_state_init(params, NULL);
    ...
    while (true) {
        ...
        for (int32_t i = 0; i < (int32_t) batch.n_tokens; i += n_batch) {
            ...
            for (auto & client : clients) {
                ...
                const llama_token id = llama_sample_token(ctx, NULL, sampling_state, client.tokens_prev, candidates, client.i_batch - i, client.seq_id);
                ...
                if (client.n_decoded > 2 &&
                    ...
                    llama_sampling_state_reset(sampling_state, client.seq_id);
                    client.seq_id = -1;
                }
