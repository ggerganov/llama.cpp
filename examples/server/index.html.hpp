// Using raw string literal instead of HEX.
// This is only used if llama.cpp/examples/server/public/index.html is not present.
unsigned char index_html[] = R"HTML(
<html>
  ...
  <script type="module">
    ...
    const ConfigForm = (props) => {
      ...
      const GrammarControl = () => (
        html`
          <div>
            <label for="template" title="Grammar will fail your request if not valid or blank.">Grammar</label>
