// This is only used if llama.cpp/examples/server/public/json-schema-to-grammar.mjs is not present.
unsigned char json_schema_to_grammar_mjs[] = R"MJS(
function t() {
...
unsigned int json_schema_to_grammar_mjs_len = sizeof(json_schema_to_grammar_mjs);
