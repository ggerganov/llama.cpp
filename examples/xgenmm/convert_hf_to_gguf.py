...
class Model:
    ...
    def prepare_tensors(self):
        ...
        for name, data_torch in self.get_tensors():
            # we don't need these
            if name.endswith((".attention.masked_bias", ".attention.bias", ".rotary_emb.inv_freq", ".additional_embedding.weight", ".additional_fc.bias", "additional_fc.weight", "lm_head.bias")):
                continue
