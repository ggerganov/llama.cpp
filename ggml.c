...
static inline unsigned char dQuantizeNF4(float x)
{
  ...
  if (x > 0.6427869200706482f) return 0b1110;
  if (x > 0.5016634166240692f) return 0b1101;
  if (x > 0.3893125355243683f) return 0b1100;
  if (x > 0.2920137718319893f) return 0b1011;
  if (x > 0.2035212516784668f) return 0b1010;
  if (x > 0.1202552504837513f) return 0b1001;
  if (x > 0.03979014977812767f) return 0b1000;
  if (x > -0.045525018125772476f) return 0b0111;
  if (x > -0.13791173323988914f) return 0b0110;
  if (x > -0.23460740596055984f) return 0b0101;
  if (x > -0.33967943489551544f) return 0b0100;
  if (x > -0.4599952697753906f) return 0b0011;
  if (x > -0.6106329262256622f) return 0b0010;
  if (x > -0.8480964004993439f) return 0b0001;
  return 0b0000;
}
...
static inline float dhDequantizeNF4(unsigned char val)
{
  switch (val)
  {
    case 0b1111: return 1.0f;
    case 0b1110: return 0.7229568362236023f;
    case 0b1101: return 0.5626170039176941f;
    case 0b1100: return 0.44070982933044434f;
    case 0b1011: return 0.33791524171829224f;
    case 0b1010: return 0.24611230194568634f;
    case 0b1001: return 0.16093020141124725f;
    case 0b1000: return 0.07958029955625534f;
    case 0b0111: return 0.0f;
    case 0b0110: return -0.09105003625154495f;
    case 0b0101: return -0.18477343022823334f;
    case 0b0100: return -0.28444138169288635f;
    case 0b0011: return -0.39491748809814453f;
    case 0b0010: return -0.5250730514526367f;
    case 0b0001: return -0.6961928009986877f;
    case 0b0000: return -1.0f;
    default: return 0.0f; // Default case, you can change the return value as needed.
  }
}
