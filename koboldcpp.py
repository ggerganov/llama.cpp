...
if __name__ == '__main__':
    ...
    parser.add_argument("--blasbatchsize", help="Sets the batch size used in BLAS processing (default 512, limit 256 for non-llama)", type=int,choices=[32,64,128,256,512,1024,2048], default=512)
