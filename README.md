...
Your model is not yet in the list ? New architecture contributions are welcomed, have a look to [HOWTO Add a model.md](./docs/HOWTO-add-model.md) to `llama.cpp`. 
